...
</style></head><body><header><div class="top"><h1>Heltec LoRa Interface</h1><div id="ip"></div></div>
<nav id="tabs"><button data-page="overview" class="active">Overview</button><button data-page="chat">Chat</button><button data-page="map">Map</button><button data-page="nodes">Nodes</button><button data-page="storage">Storage</button><button data-page="config">Config</button><button data-page="diagnostics">Diagnostics</button><button data-page="serialPage">Serial</button><button data-page="logs">Logs</button></nav></header><main>
<section class="page active" id="overview"><div class="card"><h2>Radio</h2><div class="stats" id="stats"></div><button onclick="fetch('/config',{method:'POST'})">Request Config</button></div><div class="card"><h2>Current Config</h2><div class="stats" id="configRef"></div><div class="tablewrap"><table><thead><tr><th>Index</th><th>Role</th><th>Name</th><th>State</th></tr></thead><tbody id="channelRef"></tbody></table></div></div></section>
<section class="page" id="chat"><div class="card"><h2>Send Message</h2><input id="msg" maxlength="233" placeholder="Message to mesh"><button onclick="send()">Send</button></div><div class="card"><h2>Chat</h2><pre id="chatLog"></pre></div></section>
...
chatLog.textContent=s.chat||'No chat yet';eventLog.textContent=s.log||'Waiting for radio data';
